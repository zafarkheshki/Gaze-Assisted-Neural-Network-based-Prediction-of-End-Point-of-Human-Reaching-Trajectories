...
for i in range(5):
    ...
    img = cv2.resize(im1, (293, 293), interpolation = cv2.INTER_AREA)
        ...
        # image = im1
    image = cv2.imwrite("/home/zafar/Deepgaze_images_new/image"+str(i+counter)+".jpg", im1)
    ...
    with open('/home/zafar/catkin_ws/src/Thesis/reading_angle_values/Deepgaze_new/gaze_record.txt', 'a+') as text_file:
